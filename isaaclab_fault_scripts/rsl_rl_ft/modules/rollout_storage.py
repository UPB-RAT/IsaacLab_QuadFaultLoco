...
class RolloutStorage:
    ...
    def __init__(
        ...
        self.observation_history = torch.zeros(num_transitions_per_env, num_envs, num_hist, obs_shape, device=self.device)
    ...
    def mini_batch_generator(self, num_mini_batches, num_epochs=8):
        ...
        for epoch in range(num_epochs):
            for i in range(num_mini_batches):
                ...
                yield obs_batch, next_obs_batch, obs_hist_batch, privileged_observations_batch, actions_batch, target_values_batch, advantages_batch, returns_batch, old_actions_log_prob_batch, old_mu_batch, old_sigma_batch, (
                    None,
                    None,
