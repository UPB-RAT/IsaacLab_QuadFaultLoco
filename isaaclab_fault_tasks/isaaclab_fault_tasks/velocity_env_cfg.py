...
import isaaclab_fault.envs.mdp as mdp
from isaaclab_fault.actuators import CustomDCMotorCfg
##
# Pre-defined configs
##
...
class MySceneCfg(InteractiveSceneCfg):
    ...
    height_scanner = RayCasterCfg(
        ...
        pattern_cfg=patterns.GridPatternCfg(resolution=0.1, size=[1.0, 1.6]),
        debug_vis=False,
...
class LocomotionVelocityRoughEnvCfg(ManagerBasedRLEnvCfg):
    ...
    num_action: int = 12
    num_scan: int = 187
    num_priv_phys: int = 29
    num_hist: int = 5
    priv_motors_info: bool = False
